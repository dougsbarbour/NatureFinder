...
describe('ReptileSearchComponent', () => {
  let component;
  let modelName = 'reptile';
  let modelNamePlural = 'reptiles';
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [ReptileSearchComponent, OrganismSearchComponent,
        RouterLinkDirectiveStub, QueryParamsDirectiveStub],
      schemas: [NO_ERRORS_SCHEMA]
    })
      .compileComponents();
    setFixture(TestBed.createComponent(ReptileSearchComponent));
