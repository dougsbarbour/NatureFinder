...
import {AmphibianSearchComponent} from "./amphibian-search.component";
...
describe('AmphibianSearchComponent', () => {
  let component;
  let modelName = 'amphibian';
  let modelNamePlural = 'amphibians';
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [AmphibianSearchComponent, OrganismSearchComponent,
        RouterLinkDirectiveStub, QueryParamsDirectiveStub],
      schemas: [NO_ERRORS_SCHEMA]
    })
      .compileComponents();
    setFixture(TestBed.createComponent(AmphibianSearchComponent));
